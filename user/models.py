...
class ActivatedAlgorithm(models.Model):
    ...
    short_moving_avg = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    long_moving_avg = models.DecimalField(max_digits=10, decimal_places=2,  default=0)
